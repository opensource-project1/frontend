...
function TimerPage() {
  ...
  useEffect(() => {
    ...
    if (isRunning && !isPaused && timeLeft > 0) {
      ...
      const prev = parseInt(
        localStorage.getItem("todayFocusMinutes") || "0",
        10
      );
  ...
  return (
    ...
    >
      <CenterModal>
        <div className="tabs">
          <div className="tab" onClick={() => navigate("/mypage")}>
            MYPAGE
          </div>
          <div className="tab" onClick={() => navigate("/main")}>
            START
          </div>
          <div className="tab" onClick={() => navigate("/record")}>
            RECORD
          </div>
        ...
        <div className="screen-box">
          ...
          >
            <div
              ...
              style={{ flex: 1, minWidth: 0, paddingLeft: 48 }}
            >
              <div
                className="pill-heading"
                style={{ marginTop: 64, marginBottom: 4 }}
              >
                오늘 할 일
              </div>
              <button
                onClick={handleEmergencyStop}
                className="emergency-btn stop-button"
                style={{
                  position: "fixed",
                  right: 40,
                  bottom: 40,
                  ...
                  {!isRunning && (
                    <button
                      ...
                      style={{
                        ...
                        maxWidth: 220,
                        background:
                          "linear-gradient(to bottom, #ff82d3, #d79bff)",
                        color: "#fff",
                        border: "none",
                      }}
                    >
